...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::taticoma_msgs::LegIKRequest_<ContainerAllocator> >
  {
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::taticoma_msgs::LegIKRequest_<ContainerAllocator>& v)
  {
    s << indent << "leg_number: ";
