...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::taticoma_msgs::GetLegIKSolverRequest_<ContainerAllocator> >
  {
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::taticoma_msgs::GetLegIKSolverRequest_<ContainerAllocator>& v)
  {
